...
import { ArrowRightLeft, Copy, Upload, FileCode, Check, Trash2, Download } from "lucide-react";
...
export default function Base64ConverterClient({ children }: { children?: React.ReactNode }) {
    ...
    <div className="min-h-screen bg-muted/40 p-4 md:p-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Base64 Converter</h1>
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <Card className="border-muted-foreground/20 shadow-sm flex flex-col h-full bg-muted/30">
                     <CardHeader className="flex flex-row items-center justify-between">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => handleCopy(outputText)} disabled={!outputText}>
            ...
            <TabsContent value="file">
              <Card className="border-muted-foreground/20 shadow-sm">
                <CardHeader>
                  ...
                  <CardDescription>Upload a file to convert it to a Data URI (Base64).</CardDescription>
                </CardHeader>
                    ...
                    {fileOutput && (
                        <div className="space-y-4 animate-in fade-in slide-in-from-top-4">
                            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border">
                                ...
                                <div className="flex gap-2">
                                     <Button variant="outline" size="sm" onClick={handleClearFile} className="text-destructive hover:text-destructive">
                                        Remove
                                    </Button>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Button variant="ghost" size="sm" onClick={() => handleCopy(fileOutput)}>
