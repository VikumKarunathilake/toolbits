        ...
        <div className="mt-16 prose prose-slate dark:prose-invert max-w-none">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <strong>ASCII character-set</strong>. Since URLs often contain
              characters outside the ASCII set, the URL has to be converted into
              a valid ASCII format. URL encoding replaces unsafe ASCII
