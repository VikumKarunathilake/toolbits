        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="border-muted-foreground/20 shadow-sm flex flex-col">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <CardTitle className="text-sm font-medium uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                        Header
                        <Badge variant="outline" className="text-[10px] font-normal">ALGORITHM & TOKEN TYPE</Badge>
                    </CardTitle>
                    <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => handleCopy(header, "Header")} disabled={!header}>
            ...
            <Card className="border-muted-foreground/20 shadow-sm flex flex-col">
                 <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <CardTitle className="text-sm font-medium uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                        Payload
                        <Badge variant="outline" className="text-[10px] font-normal">DATA</Badge>
                    </CardTitle>
                    <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => handleCopy(payload, "Payload")} disabled={!payload}>
                        <Copy className="w-4 h-4" />
                    </Button>
                </CardHeader>
                <CardContent className="flex-1">
