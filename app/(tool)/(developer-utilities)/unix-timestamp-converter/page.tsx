...
export default function UnixTimestampConverter() {
  const jsonLd = {
    ...
    featureList:
      "Bi-directional conversion, ISO 8601 support, Timezone handling",
  };
        ...
        <div className="mt-16 prose prose-slate dark:prose-invert max-w-none">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              <strong>Unix time</strong> (also known as Epoch time) is a system
              for describing a point in time. It is the number of seconds that
              have elapsed since the <strong>Unix Epoch</strong>, minus leap
          ...
          <section className="mt-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Computers prefer simple integers over complex date strings. Unix
              timestamps make it easy to calculate time differences (just
              subtract one number from another) regardless of time zones.
            </p>
          </section>
        </div>
      </UnixTimestampConverterClient>
