...
import { Copy, Trash2, Check, RefreshCw, Fingerprint, Settings2 } from "lucide-react";
                    ...
                    <div className="space-y-4">
                        <div className="space-y-3">
                             <div className="flex items-center justify-between">
                                <Label htmlFor="count-slider">Quantity: <span className="font-mono text-primary font-bold">{count}</span></Label>
                            </div>
                            <Slider
                                id="count-slider"
                                value={[count]}
                        ...
                        <div className="flex items-center justify-between">
                            <Label htmlFor="hyphens-switch" className="flex flex-col gap-1">
                                <span>Hyphens</span>
                                <span className="font-normal text-xs text-muted-foreground">Include dashes (standard)</span>
                            </Label>
                            <Switch id="hyphens-switch" checked={hyphens} onCheckedChange={setHyphens} />
                        </div>
                        
                        <Separator />

                        <div className="flex items-center justify-between">
                            <Label htmlFor="uppercase-switch" className="flex flex-col gap-1">
                                <span>Uppercase</span>
                                <span className="font-normal text-xs text-muted-foreground">A-Z instead of a-z</span>
                            </Label>
                            <Switch id="uppercase-switch" checked={uppercase} onCheckedChange={setUppercase} />
                        </div>
                    </div>
                    
                    <Button variant="secondary" className="w-full mt-4" onClick={handleGenerate}>
                        Generate UUIDs
                    </Button>
                </CardContent>
             </Card>
